...
const (
	...
	TeamServiceName = "mirai.v1.TeamService"
)
...
// NewTeamServiceClient constructs a client for the mirai.v1.TeamService service. By default, it
...
func NewTeamServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TeamServiceClient {
	...
	teamServiceMethods := v1.File_mirai_v1_team_proto.Services().ByName("TeamService").Methods()
...
// ListTeams calls mirai.v1.TeamService.ListTeams.
...
// GetTeam calls mirai.v1.TeamService.GetTeam.
...
// CreateTeam calls mirai.v1.TeamService.CreateTeam.
...
// UpdateTeam calls mirai.v1.TeamService.UpdateTeam.
...
// DeleteTeam calls mirai.v1.TeamService.DeleteTeam.
...
// ListTeamMembers calls mirai.v1.TeamService.ListTeamMembers.
...
// AddTeamMember calls mirai.v1.TeamService.AddTeamMember.
...
// RemoveTeamMember calls mirai.v1.TeamService.RemoveTeamMember.
...
// TeamServiceHandler is an implementation of the mirai.v1.TeamService service.
...
func NewTeamServiceHandler(svc TeamServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/mirai.v1.TeamService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTeamServiceHandler) ListTeams(context.Context, *connect.Request[v1.ListTeamsRequest]) (*connect.Response[v1.ListTeamsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TeamService.ListTeams is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) GetTeam(context.Context, *connect.Request[v1.GetTeamRequest]) (*connect.Response[v1.GetTeamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TeamService.GetTeam is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) CreateTeam(context.Context, *connect.Request[v1.CreateTeamRequest]) (*connect.Response[v1.CreateTeamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TeamService.CreateTeam is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) UpdateTeam(context.Context, *connect.Request[v1.UpdateTeamRequest]) (*connect.Response[v1.UpdateTeamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TeamService.UpdateTeam is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) DeleteTeam(context.Context, *connect.Request[v1.DeleteTeamRequest]) (*connect.Response[v1.DeleteTeamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TeamService.DeleteTeam is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) ListTeamMembers(context.Context, *connect.Request[v1.ListTeamMembersRequest]) (*connect.Response[v1.ListTeamMembersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TeamService.ListTeamMembers is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) AddTeamMember(context.Context, *connect.Request[v1.AddTeamMemberRequest]) (*connect.Response[v1.AddTeamMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TeamService.AddTeamMember is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) RemoveTeamMember(context.Context, *connect.Request[v1.RemoveTeamMemberRequest]) (*connect.Response[v1.RemoveTeamMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TeamService.RemoveTeamMember is not implemented"))
}
