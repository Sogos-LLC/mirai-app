...
const (
	...
	HealthServiceName = "mirai.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/mirai.v1.HealthService/Check"
)

// HealthServiceClient is a client for the mirai.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the mirai.v1.HealthService service. By default, it
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_mirai_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls mirai.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the mirai.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/mirai.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.HealthService.Check is not implemented"))
}
