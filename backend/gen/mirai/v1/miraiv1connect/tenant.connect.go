...
const (
	...
	TenantServiceName = "mirai.v1.TenantService"
)
...
const (
	...
	TenantServiceGetTenantProcedure = "/mirai.v1.TenantService/GetTenant"
	// TenantServiceUpdateTenantProcedure is the fully-qualified name of the TenantService's
	// UpdateTenant RPC.
	TenantServiceUpdateTenantProcedure = "/mirai.v1.TenantService/UpdateTenant"
)

// TenantServiceClient is a client for the mirai.v1.TenantService service.
...
// NewTenantServiceClient constructs a client for the mirai.v1.TenantService service. By default, it
...
func NewTenantServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TenantServiceClient {
	...
	tenantServiceMethods := v1.File_mirai_v1_tenant_proto.Services().ByName("TenantService").Methods()
...
// GetTenant calls mirai.v1.TenantService.GetTenant.
...
// UpdateTenant calls mirai.v1.TenantService.UpdateTenant.
...
// TenantServiceHandler is an implementation of the mirai.v1.TenantService service.
...
func NewTenantServiceHandler(svc TenantServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/mirai.v1.TenantService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTenantServiceHandler) GetTenant(context.Context, *connect.Request[v1.GetTenantRequest]) (*connect.Response[v1.GetTenantResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TenantService.GetTenant is not implemented"))
}
...
func (UnimplementedTenantServiceHandler) UpdateTenant(context.Context, *connect.Request[v1.UpdateTenantRequest]) (*connect.Response[v1.UpdateTenantResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.TenantService.UpdateTenant is not implemented"))
}
