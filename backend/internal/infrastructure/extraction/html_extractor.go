...
func (e *HTMLExtractor) Extract(ctx context.Context, content []byte, filename string) (*service.ExtractedDocument, error) {
...
func (e *HTMLExtractor) extractSections(doc *html.Node) []service.DocumentSection {
...
var _ service.DocumentExtractor = (*HTMLExtractor)(nil)
