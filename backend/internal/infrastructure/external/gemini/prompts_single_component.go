...
func writeComponentInstructions(sb *strings.Builder, componentType string, pos componentPosition, req service.GenerateLessonRequest) {
	...
	case "text":
		...
		sb.WriteString("- IMPORTANT: Add <br><br> between paragraphs for visual spacing\n")
		sb.WriteString("- If content has sub-sections (like intro + items), separate them with <br><br>\n")
		...
		sb.WriteString("```html\n<p>First paragraph introducing the concept.</p><br><br>\n")
		sb.WriteString("<p><strong>Key Point 1:</strong> Explanation here.</p><br><br>\n")
