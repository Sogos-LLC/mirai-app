...
func (c *Client) EnqueueTeamKnowledgeIngestion(sourceID, tenantID, teamID, filePath string) error {
	task, err := worker.NewTeamKnowledgeIngestionTask(sourceID, tenantID, teamID, filePath)
	if err != nil {
