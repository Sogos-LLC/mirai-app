export { default as CourseWizard } from './CourseWizard';
export { default as WizardProgress } from './WizardProgress';
export { default as WizardNavigation } from './WizardNavigation';

// Step components
export { default as CourseNameStep } from './steps/CourseNameStep';
export { default as TitleDescriptionStep } from './steps/TitleDescriptionStep';
