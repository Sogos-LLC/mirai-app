...
export function PersonaEditModal(props: PersonaEditModalProps) {
  ...
  const title = personaType === 'sme' ? 'Edit Instructor' : 'Edit Audience';
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {smeForm.skills.map((skill, index) => (
                  <span
                    key={index}
                    className="flex items-center gap-1 px-3 py-1 text-sm bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 rounded-full"
                  >
                    {skill}
                    <button
