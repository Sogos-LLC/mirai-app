...
func (e *DOCXExtractor) Extract(ctx context.Context, content []byte, filename string) (*ExtractedDocument, error) {
...
func (e *DOCXExtractor) buildSections(doc *docxDocument) ([]DocumentSection, string) {
